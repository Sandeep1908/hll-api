...
import {BuildSignature} from "./gen-signature-voco.js";

const prodAPIKey = 'MDM3Mjg5YjMtYjAwOS00Njc0LWJmYWMtMjQwNDNlY2RmYWUxOjc4NWI3NmQwLWE2MWYtNGU2NC1iNzZjLWRlZGRhMWM3NGMwMg=='
...
async function  createOrder(token, req, res) {
    ...
    const outlet = "bd0a9145-93c0-4549-bce1-f643d18cb021";
...
export const initiatePaymentPraxis = async (req, res) => {
    ...
    const paymentRes = await axios.post('https://gw.praxisgate.com/cashier/cashier', {
        "merchant_id": "API-Vocomarkets.com",
        "application_key": "vocomarkets.com",
        "intent": "payment",
        "currency": "USD",
        "cid": email,
        "customer_data": {
        ...
        "return_url": "https://vocomarkets.com",
    ...
    res.send(paymentRes.data?.redirect_url || paymentRes.data)
